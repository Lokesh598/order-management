package com.lokesh.poc.product.sample;
...
public class SampleConsumer {
    ...
    private static final String TOPIC = "kafka.integrating.product-topic";
    ...
    public SampleConsumer(String bootstrapServers) {
        ...
        props.put(ConsumerConfig.CLIENT_ID_CONFIG, "product-consumer");
